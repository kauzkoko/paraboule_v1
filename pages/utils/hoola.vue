...
let sendPlay = () => {
  ...
  soundController.sendPlayHoola(localDuration.value * 1000 ?? 5000);
};
...
<style scoped>
div {
  @apply text-center text-hex-ff0000 text-18px;
}

.circle {
  transition: background-color 0.5s ease-out;
  @apply w-70vw h-70vw rounded-full bg-black border-hex-ff0000 border-40px border-solid flexCenter flex-col;
  .smaller {
